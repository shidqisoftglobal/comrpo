...
class JumboBagPage extends StatelessWidget {
  const JumboBagPage({super.key});

  @override
  Widget build(BuildContext context) {
    final jumboBagViewModel = Provider.of<JumboBagViewModel>(context);
    final jumboBags = jumboBagViewModel.jumboBag;

    return ListView.builder(
      itemCount: jumboBags.length,
      itemBuilder: (context, index) {
        // ignore: no_leading_underscores_for_local_identifiers
        final _product = jumboBags[index];
