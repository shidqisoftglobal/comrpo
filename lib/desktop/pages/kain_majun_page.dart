...
class KainMajunPage extends StatelessWidget {
  const KainMajunPage({super.key});

  @override
  Widget build(BuildContext context) {
    final kainMajunViewModel = Provider.of<KainMajunViewModel>(context);
    final kainMajuns = kainMajunViewModel.kainMajun;

    return ListView.builder(
      itemCount: kainMajuns.length,
      itemBuilder: (context, index) {
        // ignore: no_leading_underscores_for_local_identifiers
        final _product = kainMajuns[index];
